...
class NodoE
{
    friend class MatrizE<T,256,256>;
   private:
     int m_fil;
     int m_col;
     T   m_Dato;
   ...
   public:
     ...
     void setpsigcol(NodoE<T>*a)
     {
         pSigCol=a;
     }
     void setpsigfil(NodoE<T>*a)
     {
         pSigFil=a;
     }
};
...
template<class T, int fil=256, int col=256>
class MatrizE
{
private:
