...
class Nodo
{
   ...
   private:
       ...
       T       m_end;
   public:
      Nodo(T d):m_Dato(d),m_Sig(0),m_start(),m_end(){};
      void matate()
      {
...
class Lista
{
  ...
  /*     void read_file (char *filefind)
       {
          ifstream file(filefind);
          char memoria [10000];
          while (!file.eof())
          {
              file.getline(memoria,10000,'\n');
              cout<<memoria<<endl;
          }
       }*/
