...
class Grafo{
    public:
        ...
        class Arco{
            ...
            public:
                ...
                Arco(int adyacente, const C & costo_arco);
    ...
    public:
        ...
        void agregarVertice(int vertice, int x, int y);
...
{
    this->costo_arco = otroArco.devolverCosto();
    this->vertice_final = otroArco.devolverAdyacente();
}
//-----------------------------------------------------------------------------------------------//
template <typename C>
Grafo<C>::Arco::Arco(int adyacente, const C & costo)
{
    vertice_final = adyacente;
    this->costo_arco = costo;
}
//-----------------------------------------------------------------------------------------------//
template <typename C>
...
//-----------------------------------------------------------------------------------------------//
template <typename C>
void Grafo<C>::agregarVertice(int vertice, int x, int y)
{
    NGrafo Nuevo;
...
//-----------------------------------------------------------------------------------------------//
template <typename C>
void Grafo<C>::eliminarVertice(int vertice)
{
