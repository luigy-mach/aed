...
//------------------EJERCICIOS
	//01
	void print_creciente();
	void print_recursivo(Nodo<T>*p);
	//02
	void print_BFS_inv();
...
//_____________________________________________________
	...
	//01
template<class T>
void Btree<T>::print_creciente(){
	Nodo<T>*temp=this->m_pRoot;
	print_recursivo(temp);
	cout<<endl;
}	

template<class T>
void Btree<T>::print_recursivo(Nodo<T>* p){
	if(!p) return;
	print_recursivo(p->m_pSon[0]);
	cout<<p->m_Dato<<" ";
	print_recursivo(p->m_pSon[1]);
}

	//02
template<class T>
void Btree<T>::print_BFS_inv(){
	if(!m_pRoot){
